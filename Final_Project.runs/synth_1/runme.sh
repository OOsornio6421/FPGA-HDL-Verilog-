...
HD_PWD='C:/Users/oscao/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_MIPS_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_MIPS_processor.tcl
