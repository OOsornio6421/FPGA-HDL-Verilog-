...
HD_PWD='C:/Users/oscao/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_MIPS_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISC_MIPS_processor.tcl -notrace
