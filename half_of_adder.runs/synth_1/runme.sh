...
HD_PWD='C:/Users/oscao/half_of_adder/half_of_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_of_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_of_adder.tcl
