...
HD_PWD='C:/Users/oscao/half_of_adder/half_of_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log half_of_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source half_of_adder.tcl -notrace
