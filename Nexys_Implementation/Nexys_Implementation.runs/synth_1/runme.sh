...
HD_PWD='C:/Users/oscao/Nexys_Implementation/Nexys_Implementation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_sw_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_sw_led.tcl
