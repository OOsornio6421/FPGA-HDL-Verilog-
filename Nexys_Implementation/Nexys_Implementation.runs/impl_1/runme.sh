...
HD_PWD='C:/Users/oscao/Nexys_Implementation/Nexys_Implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_sw_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_sw_led.tcl -notrace
